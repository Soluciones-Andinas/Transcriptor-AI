...
|---|---|---|---|
| AC-1 | B2.1, B2.4, B3.1 | tests/integration/mcp/test_request_upload_url.py, tests/integration/api/test_upload.py, tests/integration/mcp/test_start_transcription.py | (fill at GREEN) |
